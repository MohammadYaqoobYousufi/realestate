...
import { Await, Navigate, useNavigation } from 'react-router';
...
export default function CreateListing() {
  ...
  async function onSubmit(e){
    ...
    if(geoLocationEnabled){
      ...
      location = data.status === "ZER0_RESULTS" && undefined;
    ...
    <main className="max-w-md px-2 mx-auto">
      ...
      <form onSubmit={onSubmit} >
        ...
        <input 
          ...
          minLength="10" 
          required 
          className="w-full px-4 py2 text-xl text-gray-700 bg-white border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6"/>
        ...
        <div className="mb-6" >
          ...
          <p className="text-gray-600">The first image will be the cover (max 60)</p>
          <input type="file" 
          id="images"
          onChange={onChange}
          accept=".jpg, .png, .jpeg"
